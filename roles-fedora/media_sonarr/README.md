...
media_sonarr_use_reverse_proxy: true
media_sonarr_reverse_proxy_path: "sonarr"
media_sonarr_reverse_proxy_domain: "{{ media_domain }}"
...
# Make this empty, if you have no key
media_sonarr_api_key: "{{ media_sonarr_apikey }}"
```
